#!/usr/bin/env node
// TokyoNight gradient README banner — same recipe as athena-brain's poster
// (figlet 'ANSI Shadow' + per-char gradient, serialized to a monospace-grid
// SVG so GitHub renders it in colour), minus the live stats. Zero deps: the
// figlet text is pre-rendered below.
//
...
// block/box glyphs can't drift, same trick as athena-brain's ansiToSvg.
